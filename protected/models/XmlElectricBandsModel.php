...
/**
 * This is the model class for table "xml_electric_bands_model".
 *
 * The followings are the available columns in table 'xml_electric_bands_model':
 * @property integer $id
 ...
 */
class XmlElectricBandsModel extends CActiveRecord
{
	/**
	...
	{
		return 'xml_electric_bands_model';
	}
	 ...
	 * @return XmlElectricBandsModel the static model class
	 */
	public static function model($className=__CLASS__)
	{
        ...
        public static function countElectric($userKm, $userYear, $userGuide, $guideKm, $import_id){
            ...
            if($userKm >= $guideKm){
                $data = XmlElectricBandsUpModel::model()->findAll(array(
                    'condition'=>'id_import=:idImport',
                    'params'=>array(':idImport'=>$import_id)                        
                ));                
            }else{
                $data = XmlElectricBandsModel::model()->findAll(array(
                    'condition'=>'id_import=:idImport',
                    'params'=>array(':idImport'=>$import_id)                        
                ));
            }
