...
$backurl = isset($url['backUrl'])?$url['backUrl']:'__';
// echo $backurl ;
// die;
			...
			<table id="headingTable" style="width: 100%;">
			 ...
			 <table class="$mcls">
               <tr>
                    <td width="100%">
                        <table>
                         <tr style="width: 100%; text-align: right;"><td><!-- <a href="$backurl" class="backbtn" style="font-size:65px !important;">Back</a> --></td>
                         </tr> 
                        </table>
                    </td>
                </tr>
...
<script src="https://theguide.ie/pdf/build/pdf.js"></script>
<script src="https://theguide.ie/pdf/build/pdf.worker.js"></script>
<script>
	var pdfData = atob('<?php echo $base64; ?>');
	var pdfjsLib = window['pdfjs-dist/build/pdf'];
	// The workerSrc property shall be specified.
	// pdfjsLib.GlobalWorkerOptions.workerSrc = '//mozilla.github.io/pdf.js/build/pdf.worker.js';
	pdfjsLib.GlobalWorkerOptions.workerSrc = 'https://theguide.ie/pdf/build/pdf.worker.js';
