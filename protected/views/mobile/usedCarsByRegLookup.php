<div class="contentContainer" style="width: 100%; max-width:100%">
    <?php if (isset($hideHeader) && $hideHeader==false): ?>
    <div id="carInfo"><h1 style="text-align: center; padding: 20px 0 0 0;">Enter Irish Registration</h1></div>
    <?php endif; ?>
<?php    
    echo $this->renderPartial('//mobile/_checkPlateNumberByRegLookUp', 
