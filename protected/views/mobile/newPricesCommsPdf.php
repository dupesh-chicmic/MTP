...
$html .= <<<EOD
	...
	<table id="headingTable" width="100%">
        ...
        <tr class="$mcls" style="width: 100%; text-align:right;">
...
<tr style=""> 
   <td class="heading" width="70"><b>Model</b></td>
    <td class="heading" width="210"><b>Variant</b></td>
    <td class="heading" width="140"><b>Body</b></td>
    <td class="heading text-right" width="60"><b>Fuel</b></td>
    <td class="heading text-right" width="120"><b>Transmission</b></td>
    <td class="heading text-right" width="60"><b>GVW</b></td>
    <td class="heading" width="50"><b>CC</b></td>
    <td class="heading" width="50"><b>Co2</b></td>
    <td class="heading" width="40"><b>Cat</b></td>
    <td class="heading" width="60"><b>Tax$euro</b></td>
    <td class="heading" width="90"><b>Retail$euro</b></td>
    </tr>
...
if (file_exists($file)) {
    ...
    while ($reader->read()) {
        ...
        if ($reader->getAttribute('rangecode') != $startRangeCode)
            continue;
$model=$rangeName;
$variant=$reader->getAttribute('variant');
...
//var_dump($div);
if ($i>6 && $div==0){
    $headingString1 = '</table><br pagebreak="true"/><br/><br/><br/>
	<table>
	<tr style="padding-top:30px;">
	<td colspan="10" style="margin-top:20px;"></td>
	</tr>
	<tr style=""> 
   <td class="heading" width="70"><b>Model</b></td>
    <td class="heading" width="210"><b>Variant</b></td>
...
$html .= <<<EOD
   ...
   <style>
       .heading{text-align:left;background-color: #313131;height:46px;color: #fff;}
        .items{margin: 0 auto;}
        .content{padding:5px; height:70px; color: #313131; text-align: left;}
        .items{margin: 0 auto;}
		.items th{color: #fff;}
...
$base64PdfString = $pdf->Output('MTP_commercial-vehicles_'.$manufacturer.'_'.$rangeName.'_'.$date. '.pdf', 'E');
