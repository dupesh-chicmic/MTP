									...
									if(!empty($model)){
										...
										foreach ($cars as $row)
										{
											...
											echo '<tr>';
												...
												echo '<td class="mobile-show open-varnt text-right" onclick="showContent('.$row['codenumber'].');">'
												...
												echo '<td data-label="LRP/CRP">'.$row['price'].'</td>';
											...
											echo '<tr>';
												echo '<td colspan="5" style="padding:0;">';
													...
													<div class="carForm">
														...
														<div class="form1">
															<?php            
																echo CHtml::beginForm(Yii::app()->createUrl('mobile/usedCarsArchive',array('arch'=>$arch)),'',array('onsubmit'=>'return valid();'));
																...
																echo CHtml::hiddenField('import', $arch);
...
<script type="text/javascript">
    ...
    { 
	    ...
	    document.getElementById("value_"+value_clear).innerHTML = "Adjusted Guide value &#8364;<!--<a href=\"index.php?r=mobile/generatePdf&m=UsedCarsModel&imp='.$importId.'&cn="+value_clear+ "\" target=\"_blank\"><img src=\"./images/pdf.png\" style=\"width:28px; height:28px;\" alt=\"[pdf]\" /></a>-->";    
	}
</script>