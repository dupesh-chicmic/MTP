...
<div class="row topPadding">
    <div class="small- 12 medium-6 medium-centered large-4 large-centered columns">
        ...
        <div class="row column log-in-form">
            ...
            <p><?php echo CHtml::submitButton('Login', array('class'=>'button small', 'role'=>'button')); ?></p>
            <p class="text-center"><a href="<?php echo $this->createUrl('forgotPassword'); ?>">Forgot password?</a></p>
            <?php  $base_url_website=(Yii::app()->params['website_type']==Yii::app()->params['website']['MOBILE'])?Yii::app()->params['main_url']:'http://mtp.ie/'; ?>
            <p class="text-center"><a href="#" onclick="window.top.location.href = '<?php echo $base_url_website;?>login-issue/';">Problems logging in?</a></p>
