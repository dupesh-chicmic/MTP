...
<div class="carTable" style="margin-top:0px; width: 692px;">
    ...
    <div id="headItems">
        <?php if($SHOW_CODE_COLUMN): ?>
            <div class="header" style="width:205px;">Model</div>
            <div class="header" style="width:95px;">Type</div>
            <div class="header" style="width:60px;">Body</div>
        ...
        <?php else: ?>
            ...
            <div class="header" style="width:135px;">Type</div>
            <div class="header" style="width:70px;">Body</div>
            <div class="header" style="width:120px;">LRP/CRP</div>
            <div class="header" style="width:80px;">From/To</div>
        <?php endif; ?>
    </div>        
<?php
...
foreach ($cars as $row)
{
    ...
    $width = ($SHOW_CODE_COLUMN) ? "210px;": "200px;";
    ...
    $anchor++;
    if($SHOW_CODE_COLUMN) {
        echo '<div class="modelItemType" style="width:95px;">'.$row['badge'].'</div>';
        ...
        echo '<div class="modelItem float" style="width:125px;">'.$row['badge'].'</div>';
        echo '<div class="modelItem float" style="width:60px;">'.$row['body'].'</div>';
        echo '<div class="modelItem float" style="width:110px;">'.$row['price'].'</div>';
    ...
    <div class="carForm">
        ...
        ?>
         ...
         <?php
            ...
            //pdf
            echo '<a href="'.Yii::app()->createUrl('/member/generatePdf',array('m'=>'UsedCarsModel','cn'=>$row['codenumber'],'imp'=>$importId)).'"><img src="./images/pdf.png" style="width:28px; height:28px;" alt="[pdf]" /></a>';
            echo '</span>';
        ?>
         </div>
    </div>
</div><!-- id="content_codenumber" -->
...
'function enterKm(km, trId_odznacz, formKmId, trId_zaznacz, formYearId, year, formUserKmId, UserKm, formFuelId, fuel, formGuideKmId, guideKm, value_clear){ '.$enterKmFormUzupelnij.'
    ...
    document.getElementById("value_"+value_clear).innerHTML = "Adjusted value &#8364;<a href=\"index.php?r=member/generatePdf&m=UsedCarsModel&imp='.$importId.'&cn="+value_clear+ "\"><img src=\"./images/pdf.png\" style=\"width:28px; height:28px;\" alt=\"[pdf]\" /></a>";    
}';
...
<!--<div class="row hide-for-large-up">
      <div class="small-12 columns">			
		<?php 
//                $this->renderPartial('//mobile/selectCars',array(
