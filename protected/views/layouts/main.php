...
(function() {
    ...
    <?php $page = $this->pageDisplayer->page;?>
        ...
        <div id="top" class="<?php echo Yii::app()->user->isGuest?'guest':'not_guest';?>">
            <div class="width">
                ...
                <div class="social">
                    ...
                    <a target="_blank" href="<?php echo CmsDictionary::model()->dictionaryGetText('front_facebook'); ?>" class="pointer fb"></a>
                    <a target="_blank" href="<?php echo CmsDictionary::model()->dictionaryGetText('front_twitter'); ?>"  class="pointer tw"></a>
                    <a target="_blank" href="<?php echo CmsDictionary::model()->dictionaryGetText('front_linkedin'); ?>" class="pointer other">other</a>
                </div>
            </div> <!-- width -->
        </div><!-- top -->
        <div id="slider">
            <div class="width" id="SliderContainer">
                <div id="prev"></div>
                    <?php echo CmsBanner::model()->ShowBanner();?>
                <div id="next"></div>
                <div id="panel"></div>
            </div>
        </div><!-- slider -->
        ...
        <div id="footer">
            <div class="width">
                Copyright © 2015 Motor Trade Publishers
                <a href="#" class="logo"></a>
            </div><!--width -->
        </div><!--footer -->
