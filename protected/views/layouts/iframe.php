...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/form.css" />
       ...
       <!-- <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/foundation.css" />
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->request->baseUrl; ?>/css/regHistoryCheckMobile.css" />
...
<?php if(Yii::app()->params['website_type']==Yii::app()->params['website']['API']){ ?>
    ...
    <?php 
    //if network user then logut after 20 minutes of idle
    ...
    if(!empty($lvUser->network_licences_number)){
        echo 'setTimeout(function () {
           window.parent.location.href = "http://mtp.ie/app/index.php?r=site/logoutwp"; 
        }, 1200000);';
    }
    ?>
    </script>
<?php }else{ ?>
 <script>
    ...
    if(!empty($lvUser->network_licences_number)){
        echo 'setTimeout(function () {
           window.parent.location.href = "'.Yii::app()->params['main_url'].'app/index.php?r=site/logoutwp"; 
        }, 1200000);';
    }
    ?>
    </script>
