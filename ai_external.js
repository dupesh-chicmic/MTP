...
var domain_advanced_iframe = 'http://mtp.wearedigiwolf.com'; // Check if this is your wordpress root
...
if (doIt) {
  ...
  window.jQuery || document.write("<script src='http://mtp.wearedigiwolf.com/wp-includes/js/jquery/jquery.js'></script>");
  
  // load the resize script if needed.
  if (resize_on_element_resize != '') {
      document.write("<script src='http://mtp.wearedigiwolf.com/wp-content/plugins/advanced-iframe/includes/scripts/jquery.ba-resize.min.js'></script>");
  }
